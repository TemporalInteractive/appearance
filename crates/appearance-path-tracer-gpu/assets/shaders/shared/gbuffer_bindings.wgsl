...
fn GBuffer::reproject(point_ws: vec3<f32>, resolution: vec2<u32>, prev_point_ss: ptr<function, vec2<f32>>) -> bool {
    return Frustum::point_ws_to_ss(gbuffer_constants.prev_camera_frustum, point_ws, resolution, prev_point_ss);
}