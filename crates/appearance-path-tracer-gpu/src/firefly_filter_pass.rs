...
pub struct FireflyFilterPassParameters<'a> {
...
pub fn encode(
    parameters: &FireflyFilterPassParameters,
    device: &wgpu::Device,
    ...
    let shader = pipeline_database.shader_from_src(
        device,
        include_shader_src!("crates/appearance-path-tracer-gpu/assets/shaders/firefly_filter.wgsl"),
    );
    let pipeline = pipeline_database.compute_pipeline(
        device,
        wgpu::ComputePipelineDescriptor {
            label: Some("appearance-path-tracer-gpu::firefly_filter"),
    ...
    let constants = device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
        label: Some("appearance-path-tracer-gpu::firefly_filter constants"),
...

    {
        ...
        cpass.insert_debug_marker("appearance-path-tracer-gpu::firefly_filter");
